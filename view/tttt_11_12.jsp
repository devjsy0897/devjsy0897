...
<section data-color="white" style="text-align: center;">
	<!-- <img src="./images/pic01.jpg" style="height: 100vh; overflow: hidden;"/> -->
	<video src="./css/img/SlideMain/introduce_2.mp4" style="height: 100vh; width:90vw; overflow: hidden; margin: 0 auto;" autoplay="autoplay" muted="muted" ></video>
</section>
...
<!-- 	<div style=" width: 50%; border: 3px solid yellow;"><img src="./css/img/projects/BP/BP(0).png" style="width: 70%; margin-left: 17.5%;"  /></div> -->
	<div>
		<div style=" width: 50vw; height:50vh; float: left; margin-top: 25vh; text-align: right;"><img src="./css/img/projects/BP/BP(0).png" style="width: 70%;"  /></div>
...
<section data-color="violet">
	<div>
		...
		<div style=" width: 50vw; height:50vh; float: left; margin-top: 25vh;"><img src="./css/img/projects/BP/BP(1).png" style="width: 70%;"  /></div>
